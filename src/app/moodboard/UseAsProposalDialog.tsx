...
export default function UseAsProposalDialog({ element, onClose }: UseAsProposalDialogProps) {
  ...
  return (
    ...
    >
      <div
        className="glass-strong modal-card-in flex max-h-[90vh] w-full max-w-[420px] flex-col overflow-hidden rounded-lg border border-line-2 font-sans text-brand-ink shadow-lg"
